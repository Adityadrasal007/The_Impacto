  ...
  const alumniProfiles = [
    {
      ...
      verified: true,
      mentoring: true,
      achievements: ["Tech Innovation Award 2023", "Microsoft Certified Trainer"],
      ...
      interests: ["Yoga", "Photography", "Open Source"],
      languages: ["English", "Hindi", "Kannada"],
      certifications: ["AWS Solutions Architect", "Azure Cloud Professional"]
    },
    {
      id: 2,
      name: "Arjun Patel",
    ...
    // Add more profiles with enhanced data...
    {
      ...
      verified: true,
      mentoring: true,
      achievements: ["Medical Excellence Award", "ICMR Research Grant Recipient"],
      ...
      linkedIn: "dr-meera-gupta",
      portfolio: "meeragupta.in",
      ...
      certifications: ["Medical Council of India Certified", "Digital Health Certificate"]
    }
  ];
